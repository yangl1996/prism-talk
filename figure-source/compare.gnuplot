...
plot "algorand-faster-frontier.txt" using 6:7 with linespoints ps 1.0 lw 1.5 title "Algorand", \
     ...
     "prism-secure.txt" using 4:5:(sprintf("{/Symbol b}=%02d%%", $2 * 100)) with labels point lc 7 ps 1.5 lw 1.5 right offset -0.7,-0.7 rotate by 45 title "Prism", \
